...
import uniffi.gemstone.decodePrivateKey
...
class TestDecodePrivateKey {
    ...
    fun testBase58Decode() {
        ...
        val key = decodePrivateKey(chain = Chain.Solana.string, value = testBase58Key)
        ...
        val key2 = decodePrivateKey(chain = Chain.Ethereum.string, value = hex)
    ...
    fun testImportStellarKey() {
        ...
        val key = decodePrivateKey(chain = Chain.Stellar.string, value = base32Key)
