...
class LockTimer @Inject constructor(private val userConfig: UserConfig, private val activeWalletConnectRequest: ActiveWalletConnectRequest, private val securityService: GemSecurityServiceInterface) {
