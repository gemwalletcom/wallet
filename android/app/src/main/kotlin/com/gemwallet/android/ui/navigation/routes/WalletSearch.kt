...
import com.gemwallet.android.features.wallet_tab.presents.AssetsResultsScreen
import com.gemwallet.android.features.wallet_tab.presents.WalletSearchAction
import com.gemwallet.android.features.wallet_tab.presents.WalletSearchScreen
...
@Serializable
data class AssetsResultsRoute(val query: String, val scope: WalletSearchTag, val title: String? = null) : NavKey

fun EntryProviderScope<NavKey>.walletSearchScreen(onAction: (WalletSearchAction) -> Unit) {
