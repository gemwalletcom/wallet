    ...
    fun testSolana_native_transfer() {
        ...
        assertEquals(
            "0x415965576d664f4538764f357870302b7159557733437a4450713839724b4c587a7976546a587673" +
                    ...
                    "41414143414155436f49594241414d434141454d41674141414141414141414141414141", result.first().encodeHexWith0x()
        )
    }
    ...
    fun testSolana_token_transfer() {
        ...
        assertEquals(
            "0x4163456263336c444271665a76794f3954784d4e39647244584c6c374673626e664c4f453031362f" +
                    ...
                    "4141414141414d4142514b676867454142415142416745414367774141414141414141414141673d", result.first().encodeHexWith0x()
        )
    }
