...
class GetContactsImpl(private val contactStore: GemstoneContactStore) : GetContacts {

    override fun getContacts(): Flow<List<ContactData>> = contactStore.observeContacts()

    override fun getContactRecipients(chain: Chain): Flow<List<ContactRecipient>> = contactStore.observeContactRecipients(chain)
