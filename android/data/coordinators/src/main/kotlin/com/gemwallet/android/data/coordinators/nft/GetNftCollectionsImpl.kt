...
class GetNftCollectionsImpl(private val getSession: GetSession, private val getListNftCase: GetListNft) : GetNftCollections {

    override fun invoke(collectionId: String?): Flow<List<NFTData>> = getSession()
        .filterNotNull()
