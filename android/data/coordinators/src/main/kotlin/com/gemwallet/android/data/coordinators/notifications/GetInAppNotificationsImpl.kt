...
class GetInAppNotificationsImpl(private val notificationStore: GemstoneNotificationStore) : GetInAppNotifications {

    override fun invoke(walletId: WalletId): Flow<List<InAppNotification>> = notificationStore.observeNotifications(walletId)
}
