...
class GetPerpetualPositionsImpl @Inject constructor(private val getSession: GetSession, private val perpetualStore: GemstonePerpetualStore) : GetPerpetualPositions {
