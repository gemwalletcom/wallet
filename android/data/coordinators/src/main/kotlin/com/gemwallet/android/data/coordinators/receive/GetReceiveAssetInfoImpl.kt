...
class GetReceiveAssetInfoImpl(private val getSession: GetSession, private val getAssetTokenInfo: GetAssetTokenInfo) : GetReceiveAssetInfo {

    override fun invoke(assetId: AssetId): Flow<AssetInfo?> = getSession()
        .filterNotNull()
