...
class KeystoreTransactionSigner(private val baseDir: String, private val passwordStore: PasswordStore) : GemTransactionSigner {
    override suspend fun sign(wallet: uniffi.gemstone.Wallet, input: GemSignerInput): List<GemSignedTransaction> = try {
