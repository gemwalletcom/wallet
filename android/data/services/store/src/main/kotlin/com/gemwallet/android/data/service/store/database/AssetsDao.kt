...
interface AssetsDao {
    ...
    @Query("SELECT * FROM $ASSET_INFO WHERE walletId = :walletId AND visible != 0 AND assetRank > 0 AND chain = :chain AND type != 'NATIVE' ORDER BY balanceFiatTotalAmount DESC")
