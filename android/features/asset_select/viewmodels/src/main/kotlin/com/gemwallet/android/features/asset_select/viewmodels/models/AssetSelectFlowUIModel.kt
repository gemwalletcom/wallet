...
data class AssetSelectFlowUIModel(val title: String, val showsSymbol: Boolean, val subtitle: GemAssetSubtitleStyle, val trailing: GemAssetTrailingStyle, val showsBalanceFilter: Boolean)
