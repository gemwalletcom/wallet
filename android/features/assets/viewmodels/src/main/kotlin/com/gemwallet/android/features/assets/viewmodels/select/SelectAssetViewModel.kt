...
@HiltViewModel(assistedFactory = SelectAssetViewModel.Factory::class)
class SelectAssetViewModel @AssistedInject constructor(
    ...
    @AssistedFactory
    interface Factory {
        fun create(selectType: GemSelectAssetType): SelectAssetViewModel
    }
}
