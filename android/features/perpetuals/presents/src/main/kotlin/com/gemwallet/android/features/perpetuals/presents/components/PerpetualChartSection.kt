...
@Composable
internal fun PerpetualChartSection(state: StateViewType<GemCandleChart>, period: ChartPeriod, tooltip: (ChartCandleStick) -> CandleTooltipUIModel, onPeriodSelect: (ChartPeriod) -> Unit, modifier: Modifier = Modifier) {
