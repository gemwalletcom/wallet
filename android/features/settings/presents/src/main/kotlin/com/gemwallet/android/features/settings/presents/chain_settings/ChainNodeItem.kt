...
@Composable
internal fun ChainNodeItem(model: ChainNodeUIModel, listPosition: ListPosition, isDeleteRevealed: Boolean, onDeleteReveal: () -> Unit, onDeleteCollapse: () -> Unit, onSelect: (String) -> Unit, onDelete: (() -> Unit)?) {
