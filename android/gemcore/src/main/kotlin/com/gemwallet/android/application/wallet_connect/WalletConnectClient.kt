...
interface WalletConnectClient {
    ...
    fun generateApprovedNamespaces(proposal: WalletConnectSessionProposal, supportedNamespaces: Map<String, WalletConnectSessionNamespace>): Map<String, WalletConnectSessionNamespace>
    fun approveSession(proposal: WalletConnectSessionProposal, namespaces: Map<String, WalletConnectSessionNamespace>, properties: Map<String, String>, onSuccess: () -> Unit, onError: (String) -> Unit)
    ...
    fun approveAuthentication(request: WalletConnectAuthenticationRequest, auths: List<WalletConnectAuthObject>, onSuccess: () -> Unit, onError: (String) -> Unit)
    ...
    fun generateAuthPayloadParams(payloadParams: WalletConnectAuthPayloadParams, supportedChains: List<String>, supportedMethods: List<String>): WalletConnectAuthPayloadParams
...
data class WalletConnectSession(val topic: String, val expiry: Long, val metadata: ApplicationMetadata?, val namespaces: Map<String, WalletConnectSessionNamespace>, val redirect: String?)

data class WalletConnectSessionNamespace(val chains: List<String>?, val methods: List<String>, val events: List<String>, val accounts: List<String>)

data class WalletConnectProposalNamespace(val chains: List<String>?)
...
data class WalletConnectJsonRpcRequest(val id: Long, val method: String, val params: String)

data class WalletConnectSessionRequest(val topic: String, val chainId: String?, val request: WalletConnectJsonRpcRequest)

data class WalletConnectAuthenticationRequest(val id: Long, val metadata: ApplicationMetadata?, val payloadParams: WalletConnectAuthPayloadParams)
...
data class WalletConnectVerifyContext(val origin: String, val validation: WalletConnectValidation, val isScam: Boolean?)
