...
class ConfirmInputProperties(
    ...
    fun asset(input: GemConfirmInput): Asset = transferService.asset(input.transfer.inputType).toPrimitives()
    ...
    fun feeAsset(input: GemConfirmInput): Asset = transferService.feeAsset(input.transfer.inputType).toPrimitives()
