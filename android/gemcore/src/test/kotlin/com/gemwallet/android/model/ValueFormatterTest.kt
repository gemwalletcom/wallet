...
class ValueFormatterTest {
    ...
    fun short() {
        ...
        assertEquals("1.00 BTC", f.string(BigInteger.valueOf(100_000_000L), decimals = 8, currency = "BTC"))
        assertEquals("82.95 TRX", f.string(BigInteger.valueOf(82_950_000L), decimals = 6, currency = "TRX"))
        assertEquals("8,295.00 TRX", f.string(BigInteger.valueOf(8_295_000_000L), decimals = 6, currency = "TRX"))
        // >= 0.1 → 2 fraction digits, < 0.1 → 4 fraction digits
        ...
        assertEquals("0.00 BTC", f.string(BigInteger.ONE, decimals = 8, currency = "BTC"))
    }
    ...
    fun auto() {
        ...
        assertEquals("1.00", f.string(BigInteger("1000000000000000000"), decimals = 18))
    ...
    fun full() {
        ...
        assertEquals("1.00 ETH", f.string(BigInteger("1000000000000000000"), decimals = 18, currency = "ETH"))
        assertEquals("1.50 ETH", f.string(BigInteger("1500000000000000000"), decimals = 18, currency = "ETH"))
        assertEquals("1.23456789 ETH", f.string(BigInteger("1234567890000000000"), decimals = 18, currency = "ETH"))
        assertEquals("15,000.00 USDT", f.string(BigInteger("15000000000000000000000"), decimals = 18, currency = "USDT"))
