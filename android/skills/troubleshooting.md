...
Never edit files generated by `just generate-models` or UniFFI. If Android models look wrong after a Core change:
```bash
cd .. && just generate
```
...
- `gemcore/src/main/kotlin/com/wallet/core/primitives/generated/` for the generated primitives models
- Kotlin files with a `// Generated by` header
