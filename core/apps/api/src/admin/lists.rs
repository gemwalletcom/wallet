...
pub async fn add_list(_permission: PermissionAdminWrite, request: Json<FetchListPayload>, stream_producer: &State<StreamProducer>) -> Result<ApiResponse<FetchListPayload>, ApiError> {
