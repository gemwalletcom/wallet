...
pub async fn add_transaction(_permission: PermissionAdminWrite, transaction_id: Json<TransactionId>, cacher: &State<CacherClient>, stream_producer: &State<StreamProducer>) -> Result<ApiResponse<TransactionId>, ApiError> {
