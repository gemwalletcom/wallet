...
pub async fn get_defi_positions(_permission: PermissionChainRead, chain: ChainParam, address: AddressParam, client: &State<DefiProviderClient>) -> Result<ApiResponse<Vec<DefiPosition>>, ApiError> {
