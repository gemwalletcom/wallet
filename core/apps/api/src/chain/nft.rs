...
pub async fn get_nft_asset(_permission: PermissionChainRead, asset_id: NftAssetIdParam, client: &State<NFTProviderClient>) -> Result<ApiResponse<NFTAsset>, ApiError> {
