...
impl WorkerJob {
    fn spec(&self) -> JobSpec {
        ...
        match self {
            ...
            UpdateAssetListsIndex => JobSpec::new(WorkerService::Search, JobInterval::Config(ConfigKey::SearchAssetListsUpdateInterval)),
