...
use primitives::{Account, Chain, ConnectionState, GasPriceType, NFTImages, PriceAlert, StakeAction, StakeOwner, SwapPriceImpact, TransferDataExtra, Wallet};
use std::str::FromStr;
...
pub enum StakeOwner {
    Wallet,
    Validator(primitives::DelegationValidator),
}
