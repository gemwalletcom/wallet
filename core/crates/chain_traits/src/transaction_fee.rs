use primitives::{FeePriority, FeeRate, FeeUnitType, GasPriceType, SOLANA_PRIORITY_FEE_SCALE, TransactionFee};
...
impl TransactionFeeEstimate {
    pub(crate) fn new(rate: &FeeRate, units: Option<u64>, fee_unit_type: FeeUnitType) -> Self {
        ...
        Self {
            ...
            fee: TransactionFee::new_gas_price_type(gas_price_type, fee, units.unwrap_or(1).into(), Default::default()),
        }
    }
}
