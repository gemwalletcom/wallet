...
mod tests {
    ...
    fn test_transaction_encode_and_id() {
        let transaction = Transaction {
            inputs: vec![TransactionInput::mock(), TransactionInput::mock_with("554f2fd942a23d06835d26bbd78f0106fa94c8a551114a0bef81927f66467af0", 0)],
            outputs: vec![
                TransactionOutput::mock(),
                TransactionOutput::mock_with("addr1q92cmkgzv9h4e5q7mnrzsuxtgayvg4qr7y3gyx97ukmz3dfx7r9fu73vqn25377ke6r0xk97zw07dqr9y5myxlgadl2s0dgke5", 16_749_189),
            ],
            fee: 165_555,
        ...
        assert_eq!(hex::encode(transaction.transaction_id()), "cc262713a3e15a0fa245b062f33ffc6c2aa5a64c3ae7bfa793414069914e1bbf");
    }
