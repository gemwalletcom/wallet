...
impl V3Deployment {
    fn v2(factory: &'static str, quoter_v2: &'static str, permit2: &'static str, universal_router: &'static str) -> Self {
        Self {
            ...
            permit2,
            universal_router,
            universal_router_abi: UniversalRouterAbi::V2,
        }
    }
...
pub fn get_universal_router_abi_by_chain_contract(chain: &Chain, contract: &str) -> Option<UniversalRouterAbi> {
    if let Some(deployment) = get_uniswap_router_deployment_by_chain(chain)
...
fn legacy_uniswap_router_contracts_by_chain(chain: &Chain) -> &'static [&'static str] {
    match chain {
        Chain::Ethereum => &[ETHEREUM_UNISWAP_V3_UNIVERSAL_ROUTER_CONTRACT],
        Chain::Base => &[BASE_UNISWAP_V3_UNIVERSAL_ROUTER_CONTRACT],
        Chain::Optimism => &[OPTIMISM_UNISWAP_V3_UNIVERSAL_ROUTER_CONTRACT],
        Chain::Arbitrum => &["0x5E325eDA8064b456f4781070C0738d849c824258"],
        Chain::Polygon => &["0xec7BE89e9d109e7e3Fec59c222CF297125FEFda2"],
        Chain::AvalancheC | Chain::SmartChain => &["0x4Dae2f939ACf50408e13d58534Ff8c2776d45265"],
        Chain::Celo | Chain::Blast => &["0x643770E279d5D0733F21d6DC03A8efbABf3255B4"],
        Chain::World => &["0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D"],
        Chain::Unichain => &[UNICHAIN_UNISWAP_V3_UNIVERSAL_ROUTER_CONTRACT],
        Chain::Monad => &["0x0D97Dc33264bfC1c226207428A79b26757fb9dc3"],
        Chain::XLayer => &["0xDa00aE15d3A71466517129255255db7c0c0956d3"],
        _ => &[],
    }
}
...
mod tests {
    ...
    #[test]
    fn test_uniswap_v3_deployments() {
        let ethereum = get_uniswap_router_deployment_by_chain(&Chain::Ethereum).unwrap();
        let base = get_uniswap_router_deployment_by_chain(&Chain::Base).unwrap();
