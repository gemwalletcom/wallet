...
pub(super) const MIN_ARGON2_MEMORY_KIB: u32 = 19_456;
pub(super) const MIN_ARGON2_ITERATIONS: u32 = 2;
pub(super) const MIN_ARGON2_PARALLELISM: u32 = 1;
pub(super) const DEFAULT_ARGON2_MEMORY_KIB: u32 = MIN_ARGON2_MEMORY_KIB;
pub(super) const DEFAULT_ARGON2_ITERATIONS: u32 = MIN_ARGON2_ITERATIONS;
pub(super) const DEFAULT_ARGON2_PARALLELISM: u32 = MIN_ARGON2_PARALLELISM;
