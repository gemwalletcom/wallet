...
rewards_error_username_taken = Dieser Benutzername ist bereits vergeben.
rewards_error_username_wallet_has_username = Diese Brieftasche hat bereits einen Benutzernamen.
rewards_error_username_limit_reached = Zu viele Versuche, einen Benutzernamen zu erstellen. Bitte versuchen Sie es später erneut.
rewards_error_redemption_not_eligible = Mit diesem Konto können keine Prämien eingelöst werden.
rewards_error_redemption_limit_reached = Sie haben das Einlöselimit erreicht. Bitte versuchen Sie es später erneut.
rewards_error_redemption_account_too_new = Ihr Konto ist zu neu, um Prämien einzulösen. Bitte versuchen Sie es später erneut.
rewards_error_redemption_cooldown = Nach neuen Empfehlungen sind Einlösungen eine Zeit lang pausiert. Bitte versuchen Sie es später erneut.
rewards_error_redemption_not_enough_points = Sie haben nicht genug Punkte für diese Prämie.
rewards_error_redemption_option_not_available = Diese Prämie ist nicht mehr verfügbar.
rewards_error_redemption_no_username = Erstellen Sie einen Benutzernamen, um Prämien einzulösen.
