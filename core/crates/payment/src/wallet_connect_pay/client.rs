...
impl<C: Client> WalletConnectPayClient<C> {
    ...
    pub async fn get_options(&self, payment_id: &str, accounts: Vec<String>) -> Result<PaymentOptionsResponse, PaymentError> {
    ...
    pub async fn confirm(&self, payment_id: &str, option_id: &str, action_results: Vec<String>) -> Result<PaymentStatusResponse, PaymentError> {
