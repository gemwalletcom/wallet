...
pub enum ConfigKey {
    ...
    PriceTimerAssets,
    PriceTimerAssetsNew,
    PriceMetadataPublishInterval,
    PriceMetadataBatchSize,
    PriceMetadataRetryInterval,
    PriceMissingCooldown,
    ...
    TransactionInTransitMaxCheckInterval,
    TransactionInTransitCheckIntervalFactor,
...
impl ConfigKey {
    ...
    pub fn default_value(&self) -> &'static str {
        match self {
            ...
            Self::PriceMetadataPublishInterval => "1m",
            Self::PriceMetadataBatchSize => "100",
            Self::PriceMetadataRetryInterval => "15m",
            Self::PriceMissingCooldown => "1d",
            ...
            Self::TransactionInTransitMaxCheckInterval => "5m",
            Self::TransactionInTransitCheckIntervalFactor => "2.0",
