...
impl ImageFormatter {
    ...
    pub fn get_asset_list_url(url: &str, id: &str) -> String {
...
mod tests {
    ...
    #[test]
    fn test_get_asset_list_url() {
        assert_eq!(ImageFormatter::get_asset_list_url(URL, "trending"), "https://example.com/lists/trending.png");
    }
