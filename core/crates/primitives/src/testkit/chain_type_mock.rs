use crate::{
    ChainType,
    asset_constants::{
        APTOS_USDT_TOKEN_ID, ETHEREUM_USDT_TOKEN_ID, HYPERCORE_SPOT_USDC_TOKEN_ID, NEAR_USDT_TOKEN_ID, SOLANA_USDC_TOKEN_ID, STELLAR_USDC_TOKEN_ID, SUI_USDC_TOKEN_ID, TON_USDT_TOKEN_ID, TRON_USDT_TOKEN_ID, XRP_RLUSD_TOKEN_ID,
    },
};
