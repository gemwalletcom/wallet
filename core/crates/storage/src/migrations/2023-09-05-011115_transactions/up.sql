...
CREATE TYPE transaction_state AS ENUM ('pending', 'confirmed', 'inTransit', 'failed', 'reverted', 'refunded');
...
CREATE INDEX transactions_hash_created_at_idx ON transactions (hash, created_at DESC);
