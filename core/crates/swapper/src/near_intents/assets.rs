...
use primitives::{
    ...
    asset_constants::{
        ...
        OPTIMISM_OP_ASSET_ID, OPTIMISM_USDC_ASSET_ID, OPTIMISM_USDT_ASSET_ID, OPTIMISM_WETH_ASSET_ID, PLASMA_USDT_ASSET_ID, POLYGON_USDC_ASSET_ID, POLYGON_USDT_ASSET_ID, POLYGON_WETH_ASSET_ID, ROBINHOOD_USDG_ASSET_ID,
        ROBINHOOD_WETH_ASSET_ID, SMARTCHAIN_USDC_ASSET_ID, SMARTCHAIN_USDT_ASSET_ID, SOLANA_USDC_ASSET_ID, SOLANA_USDT_ASSET_ID, STELLAR_USDC_ASSET_ID, SUI_USDC_ASSET_ID, TON_USDT_ASSET_ID, TRON_USDT_ASSET_ID, XLAYER_USDC_ASSET_ID,
        XLAYER_USDT_ASSET_ID,
    },
};
...
pub const NEAR_INTENTS_ETH_XAUT: &str = "nep141:eth-0x68749665ff8d2d112fa859aa293f07a622782f38.omft.near";
...
pub const NEAR_INTENTS_HOOD_NATIVE: &str = "nep141:hood.omft.near";
pub const NEAR_INTENTS_HOOD_USDG: &str = "nep141:hood-0x5fc5360d0400a0fd4f2af552add042d716f1d168.omft.near";
pub const NEAR_INTENTS_HOOD_WETH: &str = "nep141:hood-0x0bd7d308f8e1639fab988df18a8011f41eacad73.omft.near";
...
pub static NEAR_INTENTS_ASSETS: LazyLock<HashMap<Chain, AssetsMap>> = LazyLock::new(|| {
    ...
    map.insert(
        Chain::Near,
        HashMap::from([
            (Chain::Near.as_asset_id(), NEAR_INTENTS_WRAP_NEAR),
            (NEAR_USDT_ASSET_ID.clone(), NEAR_INTENTS_NEAR_USDT),
            (NEAR_USDC_ASSET_ID.clone(), NEAR_INTENTS_NEAR_USDC),
        ]),
    );
    ...
    map.insert(
        ...
        HashMap::from([
            ...
            (ETHEREUM_XAUT_ASSET_ID.clone(), NEAR_INTENTS_ETH_XAUT),
        ]),
    );
