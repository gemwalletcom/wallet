...
use primitives::{
    ...
    asset_constants::{
        ...
        SEIEVM_USDT_ASSET_ID, SMARTCHAIN_USDC_ASSET_ID, SMARTCHAIN_USDT_ASSET_ID, TEMPO_USDC_ASSET_ID, UNICHAIN_USDC_ASSET_ID, WORLD_USDC_E_ASSET_ID, ZKSYNC_USDT_ASSET_ID,
    },
...
pub static SUPPORTED_CHAINS: LazyLock<Vec<SwapperChainAsset>> = LazyLock::new(|| {
    vec![
        ...
        SwapperChainAsset::Assets(Chain::Tempo, vec![TEMPO_USDC_ASSET_ID.clone()]),
    ]
});
