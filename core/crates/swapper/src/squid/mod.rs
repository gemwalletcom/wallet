...
static SUPPORTED_CHAINS: LazyLock<Vec<SwapperChainAsset>> = LazyLock::new(|| {
    vec![
        ...
        SwapperChainAsset::Assets(Chain::Osmosis, vec![AssetId::from_token(Chain::Osmosis, OSMOSIS_USDC_TOKEN_ID), AssetId::from_token(Chain::Osmosis, OSMOSIS_USDT_TOKEN_ID)]),
