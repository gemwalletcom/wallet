...
use primitives::{
    ...
    RecentActivityType, Resource, SimulationPayloadField, SimulationPayloadFieldDisplay, SimulationPayloadFieldKind, SimulationPayloadFieldType, StakeProviderType, SwapProvider,
    TotalFiatValue, TpslType, TransactionState, TransactionType, TransferDataOutputAction, TransferDataOutputType, VerificationStatus, WalletConnectionVerificationStatus,
