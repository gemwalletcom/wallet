...
pub enum TransactionInputType {
    ...
    Stake {
        asset: Asset,
        stake_type: primitives::StakeType,
    },
    TokenApprove {
        asset: Asset,
