...
use primitives::{
    Account, AccountDataType, AddressName, AddressType, Appearance, ApplicationMetadata, ApplicationMetadataSource, ApprovalData, Asset, AssetFiatValue, AssetLink, AssetMetaData,
    AssetPrice, AssetType, BalanceMetadata, BannerEvent, BannerState, BlockExplorerLink, Chain, ChainAddress, ChainType, ChartCandleStick, ChartCandleUpdate, ChartDateValue,
    ChartPeriod, ConnectionComponent, ConnectionStatus, Contact, ContactAddress, ContractCallData, Currency, Delegation, DelegationBase, DelegationState, DelegationValidator,
    Device, DeviceLocale, EarnType, FeePriority, FeeUnitType, FiatQuoteType, FiatRate, GasPriceType, Latency, LatencyType, LinkType, NFTAsset, NFTAssetData, NFTAttribute,
    NFTAttributeType, NFTCollection, NFTData, NFTImages, NFTResource, NFTType, NameProvider, NameRecord, Node, NodeState, Perpetual, PerpetualAccountMode, PerpetualBalance,
    PerpetualData, PerpetualDirection, PerpetualMarginType, PerpetualMarketData, PerpetualMetadata, PerpetualOrderType, PerpetualPosition, PerpetualPositionsSummary,
    PerpetualProvider, PerpetualTriggerOrder, Platform, PlatformStore, PortfolioAsset, PortfolioType, PriceAlert, PriceAlertDirection, PriceAlertNotificationType,
    RecentActivityType, RedelegateData, Release, ReportNft, Resource, SimulationBalanceChange, SimulationHeader, SimulationPayloadField, SimulationPayloadFieldDisplay,
    ...
    SolanaTokenProgramId, StakeProviderType, StakeType, SwapData, SwapPriceImpact, SwapPriceImpactType, SwapProvider, SwapProviderData, SwapQuote, SwapQuoteData,
    SwapQuoteDataType, TotalFiatValue, TpslType, TransactionInputType, TransactionState, TransactionType, TransferDataExtra, TransferDataOutputAction, TransferDataOutputType,
