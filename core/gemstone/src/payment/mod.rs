...
impl GemPaymentService {
    #[uniffi::constructor]
    pub fn new(provider: Arc<dyn AlienProvider>, app_id: String, client_id: String) -> Self {
        Self {
            service: PaymentService::new(
                Arc::new(AlienProviderWrapper::new(provider)),
                PaymentConfig::new(WalletConnectPayAuth::new(app_id, client_id)),
            ),
        }
    }
