...
WalletConnect Pay links and Solana Pay transaction requests are payment links: the gateway protocol, the actions a payment can ask for, identity verification, what lands on chain and how a payment is recorded and tracked are in [WALLETCONNECT_PAY.md](WALLETCONNECT_PAY.md).
