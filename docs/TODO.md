...
- **R8** **S** Node row — [iOS](../ios/Features/Settings/Sources/ChainSettings/ViewModels/ChainNodeViewModel.swift), [Android](../android/features/settings/networks/presents/src/main/kotlin/com/gemwallet/android/features/settings/networks/presents/NodeItem.kt). The whole title/subtitle/badge branch is written twice.
