...
struct AmountStakeViewModelTests {
    ...
    func makeTransferData() throws {
        ...
        #expect(stake.inputType.transactionType(transferService: transferService) == .stakeDelegate)
        #expect(unstake.inputType.transactionType(transferService: transferService) == .stakeUndelegate)
        #expect(redelegate.inputType.transactionType(transferService: transferService) == .stakeRedelegate)
        #expect(withdraw.inputType.transactionType(transferService: transferService) == .stakeWithdraw)
        #expect(freeze.inputType.transactionType(transferService: transferService) == .stakeFreeze)
        #expect(unfreeze.inputType.transactionType(transferService: transferService) == .stakeUnfreeze)
