...
public final class ChainServiceMock: ChainServiceable, @unchecked Sendable {
    ...
    public var fee: Fee = .init(fee: .zero, gasPriceType: .regular(gasPrice: .zero), gasLimit: .zero, feeAsset: .mock())
    ...
    public var transactionData: TransactionData = .init(fee: Fee(fee: .zero, gasPriceType: .regular(gasPrice: .zero), gasLimit: .zero, feeAsset: .mock()))
