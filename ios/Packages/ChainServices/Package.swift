...
let package = Package(
    ...
    products: [
        ...
        .library(name: "SimulationService", targets: ["SimulationService"]),
        .library(name: "SimulationServiceTestKit", targets: ["SimulationServiceTestKit"]),
    ...
    targets: [
        ...
        .target(
            ...
            path: "SimulationService",
            exclude: ["TestKit"],
        ),
        .target(
            name: "SimulationServiceTestKit",
            dependencies: [
                "SimulationService",
                .product(name: "PrimitivesTestKit", package: "Primitives"),
            ],
            path: "SimulationService/TestKit",
        ),
        .target(
