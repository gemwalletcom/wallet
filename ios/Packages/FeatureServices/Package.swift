...
let package = Package(
    ...
    products: [
        ...
        .library(name: "ConnectionStatusServiceTestKit", targets: ["ConnectionStatusServiceTestKit"]),
    ...
    targets: [
        ...
        .target(
            name: "ConnectionStatusServiceTestKit",
            dependencies: [
                "ConnectionStatusService",
                "Gemstone",
            ],
            path: "ConnectionStatusService/TestKit",
        ),
        .testTarget(
