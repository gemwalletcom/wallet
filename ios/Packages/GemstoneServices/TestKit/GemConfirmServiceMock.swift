...
public final class GemConfirmServiceMock: GemConfirmServiceProtocol, @unchecked Sendable {
    ...
    public init(
        ...
        metadataResult = metadata ?? .success(GemConfirmMetadata(
            assetBalance: GemAssetBalance(assetId: Primitives.Asset.mock().id.identifier, available: "0", frozen: "0", locked: "0", staked: "0", pending: "0", pendingUnconfirmed: "0", rewards: "0", reserved: "0", withdrawable: "0", earn: "0", metadata: nil, isActive: true),
            feeAssetBalance: GemAssetBalance(assetId: Primitives.Asset.mock().id.identifier, available: "0", frozen: "0", locked: "0", staked: "0", pending: "0", pendingUnconfirmed: "0", rewards: "0", reserved: "0", withdrawable: "0", earn: "0", metadata: nil, isActive: true),
            prices: [],
        ))
