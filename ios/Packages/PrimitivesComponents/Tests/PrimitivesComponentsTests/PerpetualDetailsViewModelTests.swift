...
struct PerpetualDetailsViewModelTests {
    ...
    func summaryReadsTheCoreText() {
        ...
        #expect(PerpetualDetailsViewModel.mock(.open(data: .mock(direction: .long, price: "100", fiatValue: 100, size: "1", slippage: 2, leverage: 3, marketPrice: 100, marginAmount: 33.33))).listItemModel.subtitle == "LONG 3x")
    ...
    func sectionsComeFromCore() {
        let model = PerpetualDetailsViewModel.mock(.open(data: .mock(direction: .long, price: "100", fiatValue: 100, size: "1", slippage: 2, leverage: 3, entryPrice: 48000.0, marketPrice: 100, marginAmount: 33.33)))
