...
public struct PerpetualPositionsQuery: DatabaseQueryable {
    public var walletId: WalletId
    public var filter: PositionsQueryFilter?
    public var searchQuery: String

    public init(
        walletId: WalletId,
        filter: PositionsQueryFilter? = nil,
        searchQuery: String = "",
    ) {
...
extension PerpetualPositionsQuery: Equatable {}
