...
info_receive_network_fee_title = %@ مطلوب لرسوم الشبكة
info_receive_network_fee_description = أنت تستلم %@، لكن لا تملك %@. ستحتاج إليه لدفع رسوم الشبكة للمعاملات المستقبلية على %@.
