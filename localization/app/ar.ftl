...
common_copied_to_clipboard = تم النسخ إلى الحافظة
...
common_pinned_asset = تم التثبيت: %@
common_unpinned_asset = تمت إزالة التثبيت: %@
common_skip = يتخطى
...
wallet_watch_tooltip_title = محفظة للمراقبة فقط. أنت لا تتحكم في هذه الأموال.
wallet_watch_empty_state_title = أنت تشاهد هذه المحفظة.
...
wallet_sell = يبيع
wallet_receive_collection = استلام المجموعة
wallet_more = أكثر
...
transaction_estimated_confirmation = التأكيد المقدّر
...
info_payment_verification_description = للامتثال للمتطلبات التنظيمية، يحتاج هذا التاجر إلى التحقق من هويتك قبل الدفع.
...
info_estimated_confirmation_description = يعتمد هذا التقدير على رسوم المعاملة ونشاط شبكة %@ الحالي. قد يتغير وقت التأكيد الفعلي وهو غير مضمون.
...
info_balance_required_title = %@ مطلوب
info_insufficient_network_fee_balance_description = تتطلب هذه المعاملة %@ لرسوم شبكة %@، ولكن المتاح هو %@ فقط. تحتاج إلى %@ إضافية للمتابعة.
info_insufficient_balance_title = رصيد غير كاف
info_balance_required_description = تتطلب هذه المعاملة %@، ولكن المتاح هو %@ فقط. تحتاج إلى %@ إضافية للمتابعة.
...
info_swap_minimum_amount_description = يتطلب %@ حداً أدنى قدره %@، لكن المبلغ هو %@. زِد المبلغ بمقدار %@ للمتابعة.
...
nft_properties = ملكيات
nft_collections = المجموعات
nft_collection = مجموعة
nft_save_to_photos = حفظ في الصور
nft_set_as_avatar = تعيين كصورة رمزية
nft_state_empty_title = ستظهر NFTs الخاصة بك هنا
nft_state_empty_description = احصل على NFT الأول الخاص بك
nft_report_reason_spam = رسائل إلكترونية مزعجة
