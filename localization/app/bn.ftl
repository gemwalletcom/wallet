...
common_continue_anyway = তারপরও চালিয়ে যান
...
common_copied_to_clipboard = ক্লিপবোর্ডে কপি করা হয়েছে
...
common_pinned_asset = পিন করা হয়েছে: %@
common_unpinned_asset = আনপিন করা হয়েছে: %@
...
wallet_watch_tooltip_title = শুধুমাত্র দেখার ওয়ালেট। এই তহবিল আপনার নিয়ন্ত্রণে নেই।
wallet_watch_empty_state_title = আপনি এই মানিব্যাগ দেখছেন.
wallet_stake = স্টেক
...
wallet_sell = বিক্রয়
wallet_receive_collection = সংগ্রহ গ্রহণ
wallet_more = আরও
...
errors_keystore_access = এই ডিভাইসে এই ওয়ালেটের কী অ্যাক্সেস করা যায়নি। আপনার রিকভারি ফ্রেজ থাকলে, এই ওয়ালেটটি সরিয়ে আবার ইম্পোর্ট করে অ্যাক্সেস ফিরে পান।
errors_wallet_account_missing = এই ওয়ালেটে এই নেটওয়ার্কের জন্য কোনো অ্যাকাউন্ট নেই
...
transaction_estimated_confirmation = আনুমানিক নিশ্চিতকরণ
...
info_estimated_confirmation_description = এই অনুমানটি লেনদেনের ফি এবং বর্তমান %@ নেটওয়ার্ক কার্যকলাপের উপর ভিত্তি করে। প্রকৃত নিশ্চিতকরণের সময় পরিবর্তিত হতে পারে এবং এর নিশ্চয়তা নেই।
...
info_balance_required_title = %@ প্রয়োজন
info_insufficient_network_fee_balance_description = এই লেনদেনের জন্য %@ %@ নেটওয়ার্ক ফি হিসেবে প্রয়োজন, কিন্তু মাত্র %@ উপলভ্য আছে। চালিয়ে যেতে আপনার আরও %@ প্রয়োজন।
info_insufficient_balance_title = অপর্যাপ্ত ব্যালেন্স
info_balance_required_description = এই লেনদেনের জন্য %@ প্রয়োজন, কিন্তু মাত্র %@ উপলভ্য আছে। চালিয়ে যেতে আপনার আরও %@ প্রয়োজন।
...
info_swap_minimum_amount_description = %@ ন্যূনতম %@ প্রয়োজন, কিন্তু পরিমাণ হলো %@। চালিয়ে যেতে %@ বাড়ান।
...
nft_properties = বৈশিষ্ট্য
nft_collections = সংগ্রহ
...
rootcheck_jailbreak_body = আপনার ডিভাইস জেলব্রোক করা বলে মনে হচ্ছে। এতে আপনার ওয়ালেট ও তহবিল ঝুঁকিতে পড়তে পারে।
