...
info_receive_network_fee_title = Pro poplatky je potřeba %@
info_receive_network_fee_description = Přijímáte %@, ale nemáte žádné %@. Budete je potřebovat k zaplacení síťových poplatků za budoucí transakce na síti %@.
