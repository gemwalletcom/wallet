...
common_copied_to_clipboard = Zkopírováno do schránky
...
common_pinned_asset = Připnuto: %@
common_unpinned_asset = Odepnuto: %@
...
wallet_watch_tooltip_title = Peněženka pouze ke sledování. Tyto prostředky neovládáte.
wallet_watch_empty_state_title = Sledujete tuto peněženku.
wallet_stake = Stake
...
wallet_sell = Prodat
wallet_receive_collection = Přijmout sbírku
wallet_more = Více
...
transaction_estimated_confirmation = Odhadované potvrzení
...
info_payment_verification_description = Kvůli splnění regulačních požadavků musí tento obchodník před platbou ověřit vaši totožnost.
...
info_estimated_confirmation_description = Tento odhad vychází z transakčního poplatku a aktuální aktivity sítě %@. Skutečná doba potvrzení se může změnit a není zaručena.
...
info_balance_required_title = %@ je vyžadováno
info_insufficient_network_fee_balance_description = Tato transakce vyžaduje %@ na síťový poplatek sítě %@, ale k dispozici je pouze %@. K pokračování potřebujete ještě %@.
info_insufficient_balance_title = Nedostatečný zůstatek
info_balance_required_description = Tato transakce vyžaduje %@, ale k dispozici je pouze %@. K pokračování potřebujete ještě %@.
...
info_stake_frozen_required_title = Zmrazte TRX pro vsazení
info_stake_frozen_required_description = Vsázení na TRONu má dva kroky. Nejprve zmrazte TRX, poté jej vsaďte a získejte odměny.
...
nft_properties = Vlastnosti
nft_collections = Sbírky
