...
info_insufficient_network_fee_balance_description = Denne transaktion kræver %@ til dækning af netværksgebyret betalt til %@-minearbejdere, ikke Gem Wallet. Sørg for, at du har nok %@.
