...
common_copied_to_clipboard = Kopieret til udklipsholder
...
common_lists = Lister
common_unpin = Frigør
common_pinned_asset = Fastgjort: %@
common_unpinned_asset = Frigjort: %@
...
wallet_watch_tooltip_title = Tegnebog kun til overvågning. Du kontrollerer ikke disse midler.
wallet_watch_empty_state_title = Du holder øje med denne tegnebog.
...
errors_authentication_unavailable = Godkendelse er ikke konfigureret på denne enhed. Slå biometri eller en adgangskode til i enhedens indstillinger.
errors_authentication_locked_out = For mange mislykkede forsøg. Prøv igen senere.
errors_authentication_failed = Godkendelsen mislykkedes. Prøv igen.
errors_connections_expired = Dette forbindelseslink er udløbet. Hent en ny QR-kode, og prøv igen.
errors_connections_not_found = Denne forbindelse findes ikke længere.
errors_connections_relay_unavailable = Kunne ikke få forbindelse til WalletConnect. Tjek din internetforbindelse, og prøv igen.
...
transaction_estimated_confirmation = Estimeret bekræftelse
...
asset_all_time_high = Højeste nogensinde
...
banner_perpetuals_title = Handl Perpetuals på Hyperliquid
...
price_alerts_added_price_over = Alarm tilføjet for pris over %@
price_alerts_added_price_under = Alarm tilføjet for pris under %@
price_alerts_added_increases_by = Alarm tilføjet for prisstigning på %@
price_alerts_added_decreases_by = Alarm tilføjet for prisfald på %@
...
info_estimated_confirmation_description = Dette er et estimat baseret på transaktionsgebyret og den aktuelle aktivitet på %@-netværket. Den faktiske bekræftelsestid kan ændre sig og er ikke garanteret.
...
info_balance_required_title = %@ påkrævet
info_insufficient_network_fee_balance_description = Denne transaktion kræver %@ til netværksgebyret på %@, men kun %@ er tilgængelig. Du mangler %@ for at fortsætte.
info_insufficient_balance_title = Utilstrækkelig saldo
info_balance_required_description = Denne transaktion kræver %@, men kun %@ er tilgængelig. Du mangler %@ for at fortsætte.
...
info_swap_minimum_amount_description = %@ kræver mindst %@, men beløbet er %@. Forhøj det med %@ for at fortsætte.
...
simulation_warning_externally_owned_spender_description = Denne godkendelse lader en almindelig walletadresse (EOA) bruge dine aktiver. Bekræft kun, hvis du har tillid til denne adresse.
