...
info_receive_network_fee_title = %@ kræves til gebyrer
info_receive_network_fee_description = Du modtager %@, men du har ingen %@. Du får brug for det til at betale netværksgebyrer for fremtidige transaktioner på %@.
