...
info_receive_network_fee_title = %@ برای کارمزد لازم است
info_receive_network_fee_description = شما در حال دریافت %@ هستید، اما هیچ %@ ندارید. برای پرداخت کارمزد شبکه برای تراکنش‌های آینده در %@ به آن نیاز خواهید داشت.
