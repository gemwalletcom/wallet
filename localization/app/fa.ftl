...
common_copied_to_clipboard = در کلیپ‌بورد کپی شد
...
common_pinned_asset = %@ پین شد.
common_unpinned_asset = %@ از پین خارج شد.
...
wallet_watch_tooltip_title = کیف پول فقط برای مشاهده. شما کنترلی بر این وجوه ندارید.
wallet_watch_empty_state_title = شما در حال تماشای این کیف پول هستید.
wallet_stake = استیک
...
transaction_estimated_confirmation = تأیید تخمینی
...
info_payment_verification_description = فروشنده پیش از پرداخت اطلاعات بیشتری درخواست می‌کند.
...
info_estimated_confirmation_description = این تخمین بر اساس کارمزد تراکنش و فعالیت فعلی شبکه %@ است. زمان واقعی تأیید ممکن است تغییر کند و تضمین‌شده نیست.
...
info_balance_required_title = %@ مورد نیاز
info_insufficient_network_fee_balance_description = این تراکنش برای کارمزد شبکه %@ به %@ نیاز دارد، اما فقط %@ در دسترس است. برای ادامه به %@ بیشتر نیاز دارید.
info_insufficient_balance_title = موجودی ناکافی
info_balance_required_description = این تراکنش به %@ نیاز دارد، اما فقط %@ در دسترس است. برای ادامه به %@ بیشتر نیاز دارید.
...
info_swap_minimum_amount_description = %@ حداقل به %@ نیاز دارد، اما مبلغ %@ است. برای ادامه آن را %@ افزایش دهید.
...
simulation_warning_externally_owned_spender_description = این تأییدیه به یک آدرس کیف پول معمولی (EOA) اجازه می‌دهد از دارایی‌های شما استفاده کند. فقط اگر به این آدرس اعتماد دارید تأیید کنید.
