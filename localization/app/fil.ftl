...
info_receive_network_fee_title = Kailangan ng %@ para sa mga bayarin
info_receive_network_fee_description = Tumatanggap ka ng %@, ngunit wala kang %@. Kakailanganin mo ito para bayaran ang mga network fee para sa mga susunod na transaksyon sa %@.
