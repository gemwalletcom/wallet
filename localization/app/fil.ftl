...
common_copied_to_clipboard = Kinopya sa clipboard
...
common_pinned_asset = Naka-pin: %@
common_unpinned_asset = Na-unpin: %@
...
wallet_watch_tooltip_title = Wallet na pang-bantay lamang. Hindi mo kontrolado ang mga pondong ito.
wallet_watch_empty_state_title = Binabantayan mo ang wallet na ito.
wallet_stake = Mag-stake
...
errors_decoding_qr = Nabigong i-decode ang QR code. Pakisubukang muli gamit ang ibang QR code.
...
errors_dust_threshold_short = Itinuturing ng network ang halagang ito bilang alikabok (dust) - ang bayad ay mas mataas kaysa sa halaga mismo.
...
transaction_estimated_confirmation = Tinatayang kumpirmasyon
...
swap_min_receive = Pinakamababang Matatanggap
...
price_alerts_direction_over = Mahigit sa
...
price_alerts_set_alert_price_over = Kapag mahigit sa ang presyo
price_alerts_set_alert_price_under = Kapag mababa ang presyo
price_alerts_set_alert_price_increases_by = Kapag tumaas ang presyo nang
...
info_payment_verification_description = Para matugunan ang mga kinakailangan sa pagsunod, kailangang beripikahin ng merchant na ito ang iyong pagkakakilanlan bago ang bayad.
...
info_estimated_confirmation_description = Ang tantiya na ito ay batay sa bayad sa transaksyon at kasalukuyang aktibidad ng %@ network. Maaaring magbago ang aktuwal na oras ng kumpirmasyon at hindi ito garantisado.
...
info_balance_required_title = %@ kinakailangan
info_insufficient_network_fee_balance_description = Nangangailangan ang transaksyong ito ng %@ para sa bayad sa network ng %@, ngunit %@ lang ang available. Kailangan mo pa ng %@ para magpatuloy.
info_insufficient_balance_title = Hindi Sapat na Balanse
info_balance_required_description = Nangangailangan ang transaksyong ito ng %@, ngunit %@ lang ang available. Kailangan mo pa ng %@ para magpatuloy.
...
simulation_warning_externally_owned_spender_description = Hinahayaan ng pag-aprubang ito ang isang karaniwang wallet address (EOA) na gamitin ang iyong mga asset. Kumpirmahin lang kung pinagkakatiwalaan mo ang address na ito.
