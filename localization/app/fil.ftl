...
info_insufficient_network_fee_balance_description = Ang transaksyong ito ay nangangailangan ng %@ para mabayaran ang bayad sa network na ibinayad sa %@ mga minero, hindi Gem Wallet. Tiyaking mayroon kang sapat na %@.
