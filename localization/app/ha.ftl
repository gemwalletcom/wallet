...
common_copied_to_clipboard = An kwafa zuwa allo
...
common_lists = Jerin
common_unpin = Cire
common_pinned_asset = An manna: %@
common_unpinned_asset = An cire: %@
...
wallet_watch_tooltip_title = Walat na kallo kawai. Ba ku da ikon sarrafa waɗannan kuɗaɗe ba.
wallet_watch_empty_state_title = Kuna kallon wannan walat.
...
transaction_estimated_confirmation = Kiyasin tabbatarwa
...
info_payment_verification_description = Don cika ƙa'idodin doka, wannan ɗan kasuwa yana buƙatar tabbatar da ainihinka kafin biyan kuɗi.
...
info_estimated_confirmation_description = Wannan kiyasi ya dogara da kuɗin ma'amala da aikin hanyar sadarwar %@ na yanzu. Ainihin lokacin tabbatarwa na iya canzawa kuma ba shi da tabbaci.
...
info_balance_required_title = %@ ake bukata
info_insufficient_network_fee_balance_description = Wannan ciniki yana buƙatar %@ don kuɗin hanyar sadarwar %@, amma %@ kawai ake da shi. Kuna buƙatar ƙarin %@ don ci gaba.
info_insufficient_balance_title = Rashin Isasshen Ma'auni
info_balance_required_description = Wannan ciniki yana buƙatar %@, amma %@ kawai ake da shi. Kuna buƙatar ƙarin %@ don ci gaba.
...
nft_report_reason_other = Sauran
