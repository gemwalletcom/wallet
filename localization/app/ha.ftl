...
info_receive_network_fee_title = Ana buƙatar %@ don kuɗaɗe
info_receive_network_fee_description = Kana karɓar %@, amma ba ka da %@. Za ka buƙace shi don biyan kuɗin hanyar sadarwa na ma'amaloli na gaba a kan %@.
