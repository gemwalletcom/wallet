...
info_receive_network_fee_title = נדרש %@ עבור עמלות
info_receive_network_fee_description = אתה מקבל %@, אך אין לך %@. תזדקק לזה כדי לשלם עמלות רשת עבור עסקאות עתידיות ב-%@.
