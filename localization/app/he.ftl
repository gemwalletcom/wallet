...
common_copied = הועתק: %@
common_copied_to_clipboard = הועתק ללוח
...
common_pinned_asset = הוצמד: %@
common_unpinned_asset = ההצמדה בוטלה: %@
common_skip = לְדַלֵג
...
wallet_scan = סריקה
wallet_scan_hint = שלחו, שלמו או התחברו ל-DApp
wallet_scan_hint_address = כתובת הארנק
wallet_default_name = ארנק #%d
wallet_default_name_chain = %@ ארנק #%d
wallet_copy_address = העתק כתובת
wallet_watch_tooltip_title = ארנק לצפייה בלבד. אין לך שליטה על הכספים האלה.
wallet_watch_empty_state_title = אתה צופה בארנק הזה.
...
wallet_receive_collection = קבלת אוסף
wallet_more = יוֹתֵר
...
settings_appearance_system = מערכת
...
transaction_estimated_confirmation = אישור משוער
...
info_payment_verification_description = כדי לעמוד בדרישות הרגולציה, בית העסק הזה צריך לאמת את זהותך לפני התשלום.
...
info_estimated_confirmation_description = הערכה זו מבוססת על עמלת העסקה ועל הפעילות הנוכחית ברשת %@. זמן האישור בפועל עשוי להשתנות ואינו מובטח.
...
info_balance_required_title = נדרש %@
info_insufficient_network_fee_balance_description = העסקה הזו דורשת %@ עבור עמלת הרשת של %@, אבל רק %@ זמינים. נדרשים עוד %@ כדי להמשיך.
info_insufficient_balance_title = יתרה לא מספקת
info_balance_required_description = העסקה הזו דורשת %@, אבל רק %@ זמינים. נדרשים עוד %@ כדי להמשיך.
...
info_swap_minimum_amount_description = %@ דורש לפחות %@, אבל הסכום הוא %@. הגדילו אותו ב-%@ כדי להמשיך.
