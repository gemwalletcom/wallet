...
common_copied_to_clipboard = क्लिपबोर्ड पर कॉपी किया गया
...
common_pinned_asset = पिन किया गया: %@
common_unpinned_asset = अनपिन किया गया: %@
common_skip = छोडना
...
wallet_scan_hint = भेजें, भुगतान करें या DApp से कनेक्ट करें
wallet_scan_hint_address = बटुए का पता
wallet_default_name = वॉलेट #%d
wallet_default_name_chain = %@ वॉलेट #%d
wallet_copy_address = पता कॉपी करें
wallet_watch_tooltip_title = केवल देखने वाला वॉलेट। इन फ़ंड पर आपका नियंत्रण नहीं है।
wallet_watch_empty_state_title = आप यह बटुआ देख रहे हैं.
wallet_stake = स्टेक
...
wallet_sell = बेचना
wallet_receive_collection = संग्रह प्राप्त करें
wallet_more = अधिक
...
wallet_pay_with_card_or_bank = कार्ड या बैंक से भुगतान करें
# Used in the insufficient network fee sheet for the swap option subtitle.
wallet_from_your_wallet_assets = आपके वॉलेट एसेट्स से
# Used in the insufficient network fee sheet for the receive option subtitle.
wallet_transfer_from_another_wallet = दूसरे वॉलेट से ट्रांसफर करें
...
support_state_empty_description = हमसे कुछ भी पूछें। हम मदद के लिए यहाँ हैं।
support_message_placeholder = संदेश
...
errors_keystore_access = इस डिवाइस पर इस वॉलेट की कुंजियों तक पहुँच नहीं हो सकी। यदि आपके पास रिकवरी फ़्रेज़ है, तो इस वॉलेट को हटाकर दोबारा इम्पोर्ट करें और एक्सेस बहाल करें।
errors_wallet_account_missing = इस वॉलेट में इस नेटवर्क के लिए कोई खाता नहीं है
...
transaction_estimated_confirmation = अनुमानित पुष्टि
...
wallet_connect_request_expired = अनुरोध की समय-सीमा समाप्त
...
info_payment_verification_description = नियामक आवश्यकताओं को पूरा करने के लिए, इस व्यापारी को भुगतान से पहले आपकी पहचान सत्यापित करनी होगी।
...
info_estimated_confirmation_description = यह अनुमान लेन-देन शुल्क और मौजूदा %@ नेटवर्क गतिविधि पर आधारित है। वास्तविक पुष्टि समय बदल सकता है और इसकी गारंटी नहीं है।
...
info_balance_required_title = %@ आवश्यक
info_insufficient_network_fee_balance_description = इस लेनदेन के लिए %@ नेटवर्क शुल्क हेतु %@ आवश्यक है, लेकिन केवल %@ उपलब्ध हैं। जारी रखने के लिए आपको %@ और चाहिए।
info_insufficient_balance_title = अपर्याप्त शेषराशि
info_balance_required_description = इस लेनदेन के लिए %@ आवश्यक है, लेकिन केवल %@ उपलब्ध हैं। जारी रखने के लिए आपको %@ और चाहिए।
...
info_swap_minimum_amount_description = %@ के लिए न्यूनतम %@ आवश्यक है, लेकिन राशि %@ है। जारी रखने के लिए इसे %@ बढ़ाएँ।
...
nft_report_reason_other = अन्य
nft_report_report_button_title = रिपोर्ट करें
