...
common_copied_to_clipboard = Disalin ke papan klip
...
common_pinned_asset = Disematkan: %@
common_unpinned_asset = Sematan dilepas: %@
common_skip = Lewati
...
wallet_watch_tooltip_title = Dompet khusus pantau. Anda tidak mengontrol dana ini.
wallet_watch_empty_state_title = Anda sedang memantau dompet ini.
...
buy_rate = Nilai Tukar
buy_no_results = Tidak ada penawaran tersedia
...
errors_transfer_error = Kesalahan Transfer
...
charts_all = Semua
charts_entry = Masuk
charts_price_open = Pembukaan
charts_price_close = Penutupan
...
banner_perpetuals_title = Perdagangkan Perpetual di Hyperliquid
banner_perpetuals_description = Setor, perdagangkan, dan hasilkan dengan perpetual Hyperliquid
...
filter_title = Filter
filter_types = Jenis
filter_has_balance = Memiliki saldo
...
price_alerts_direction_over = Di atas
...
price_alerts_set_alert_price_over = Ketika harga di atas
...
info_payment_verification_description = Merchant meminta informasi tambahan sebelum pembayaran.
...
info_estimated_confirmation_description = Perkiraan ini didasarkan pada biaya transaksi dan aktivitas jaringan %@ saat ini. Waktu konfirmasi sebenarnya dapat berubah dan tidak dijamin.
...
info_insufficient_network_fee_balance_description = Transaksi ini memerlukan %@ untuk biaya jaringan %@, tetapi hanya %@ yang tersedia. Anda memerlukan %@ lagi untuk melanjutkan.
info_insufficient_balance_title = Saldo Tidak Cukup
info_balance_required_description = Transaksi ini memerlukan %@, tetapi hanya %@ yang tersedia. Anda memerlukan %@ lagi untuk melanjutkan.
...
info_perpetual_open_interest_description = Open interest mewakili nilai total seluruh kontrak perpetual yang belum diselesaikan. Ini memberikan wawasan tentang aktivitas pasar dan likuiditas.
...
info_perpetual_funding_apr_title = APR Pendanaan
...
info_swap_minimum_amount_description = %@ memerlukan minimal %@, tetapi jumlahnya %@. Tambahkan %@ untuk melanjutkan.
...
onboarding_accept_terms_item3_message = Saya memahami bahwa jika saya kehilangan akses ke dompet saya, Gem tidak bertanggung jawab dan tidak dapat membantu dengan cara apa pun.
...
perpetual_account_leverage = Leverage Akun
...
simulation_warning_externally_owned_spender_description = Persetujuan ini memungkinkan alamat dompet biasa (EOA) menggunakan aset Anda. Konfirmasikan hanya jika Anda mempercayai alamat ini.
