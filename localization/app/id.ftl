...
info_receive_network_fee_title = %@ diperlukan untuk biaya
info_receive_network_fee_description = Anda menerima %@, tetapi Anda tidak memiliki %@. Anda akan membutuhkannya untuk membayar biaya jaringan transaksi di masa mendatang di %@.
