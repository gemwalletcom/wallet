...
info_insufficient_network_fee_balance_description = Transaksi ini memerlukan %@ untuk menutupi biaya jaringan yang dibayarkan kepada %@ penambang, bukan Gem Wallet. Pastikan Anda memiliki cukup %@.
