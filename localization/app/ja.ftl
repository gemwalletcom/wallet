...
common_lists = リスト
common_unpin = ピン解除
common_pinned_asset = ピン留め済み: %@
common_unpinned_asset = ピン解除済み: %@
common_skip = スキップ
common_warning = 警告
...
wallet_connect_connection_title = 接続
...
nodes_import_node_title = ノードを追加
nodes_import_node_chain_id = チェーンID
nodes_import_node_in_sync = 同期済み
...
info_insufficient_network_fee_balance_description = この取引では、ネットワーク手数料を賄うために%@が必要です。この手数料はGem Walletではなく%@のマイナーに支払われます。十分な%@があることを確認してください。
...
perpetual_modify_position = ポジションを変更
