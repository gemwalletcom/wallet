...
common_show = %@ 표시
common_copied = 복사됨: %@
common_copied_to_clipboard = 클립보드에 복사됨
...
common_lists = 목록
common_unpin = 고정 해제
common_pinned_asset = 고정됨: %@
common_unpinned_asset = 고정 해제됨: %@
common_skip = 건너뛰기
common_warning = 경고
...
wallet_scan = 스캔
wallet_scan_hint = 전송, 결제 또는 DApp 연결
wallet_scan_hint_address = 지갑 주소
wallet_default_name = 지갑 #%d
wallet_default_name_chain = %@ 지갑 #%d
wallet_copy_address = 주소 복사
wallet_watch_tooltip_title = 보기 전용 지갑입니다. 이 자금을 제어할 수 없습니다.
wallet_watch_empty_state_title = 당신은 이 지갑을 보고 있습니다.
wallet_stake = 스테이크
...
transaction_estimated_confirmation = 예상 확인 시간
...
swap_slippage = 슬리피지
swap_slippage_warning = 슬리피지가 높습니다. 스왑이 예상보다 나쁜 가격에 체결될 수 있습니다.
swap_slippage_auto = 자동
swap_slippage_auto_description = 성공적인 스왑을 위해 최적의 슬리피지를 자동으로 설정합니다.
...
private_key_reveal_intro = %@ 계정의 개인 키를 표시하려고 합니다.
private_key_do_not_share_title = 개인 키를 공유하지 마세요!
private_key_do_not_share_description = 이 개인 키를 얻은 사람은 누구나 %@ 계정을 완전히 제어할 수 있습니다.
private_key_one_chain_title = 하나의 체인만 잠금 해제합니다
private_key_one_chain_description = 이 키는 %@ 계정만 제어합니다.
private_key_shared_chains_title = 여러 체인을 잠금 해제합니다
private_key_shared_chains_description = 이 키는 %@의 계정을 제어합니다.
private_key_scope_evm = 모든 EVM 체인
private_key_scope_cosmos = 모든 Cosmos 체인
...
info_estimated_confirmation_description = 이 예상치는 거래 수수료와 현재 %@ 네트워크 활동을 기반으로 합니다. 실제 확인 시간은 달라질 수 있으며 보장되지 않습니다.
...
info_balance_required_title = %@ 이 필요합니다
info_insufficient_network_fee_balance_description = 이 거래에는 %@ 네트워크 수수료로 %@이(가) 필요하지만 사용할 수 있는 금액은 %@뿐입니다. 계속하려면 %@이 더 필요합니다.
info_insufficient_balance_title = 잔액이 부족합니다
info_balance_required_description = 이 거래에는 %@이 필요하지만 사용할 수 있는 금액은 %@뿐입니다. 계속하려면 %@이 더 필요합니다.
