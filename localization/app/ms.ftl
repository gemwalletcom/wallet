...
common_copied_to_clipboard = Disalin ke papan keratan
...
common_pinned_asset = Disemat: %@
common_unpinned_asset = Dinyahsemat: %@
common_skip = Langkau
...
common_suspicious_address_description = Alamat ini dikaitkan dengan aktiviti yang mencurigakan atau berbahaya.
...
welcome_title = Selamat datang ke Gem Family
...
wallet_multicoin = Berbilang Koin
...
wallet_watch_tooltip_title = Dompet pantau sahaja. Anda tidak mengawal dana ini.
wallet_watch_empty_state_title = Anda sedang memerhati dompet ini.
wallet_stake = Pertaruhan
...
wallet_pay_with_card_or_bank = Bayar dengan kad atau bank
# Used in the insufficient network fee sheet for the swap option subtitle.
wallet_from_your_wallet_assets = Daripada aset dompet anda
# Used in the insufficient network fee sheet for the receive option subtitle.
wallet_transfer_from_another_wallet = Pindahkan daripada dompet lain
...
transfer_stake_title = Pertaruhan
transfer_claim_rewards_title = Tuntut Ganjaran
transfer_unstake_title = Nyahpertaruhan
transfer_redelegate_title = Delegasi semula
transfer_withdraw_title = Tarik Balik
...
errors_authentication_unavailable = Pengesahan belum disediakan pada peranti ini. Hidupkan biometrik atau kod laluan dalam tetapan peranti.
errors_authentication_locked_out = Terlalu banyak percubaan gagal. Sila cuba lagi kemudian.
errors_authentication_failed = Pengesahan gagal. Sila cuba lagi.
errors_connections_expired = Pautan sambungan ini telah tamat tempoh. Dapatkan kod QR baharu dan cuba lagi.
errors_connections_not_found = Sambungan ini tidak lagi wujud.
errors_connections_relay_unavailable = Tidak dapat mencapai WalletConnect. Semak sambungan internet anda dan cuba lagi.
...
transaction_estimated_confirmation = Anggaran pengesahan
...
filter_types = Jenis
filter_has_balance = Mempunyai baki
...
price_alerts_direction_over = Melebihi
...
price_alerts_set_alert_price_over = Apabila harga melebihi
...
price_alerts_added_price_over = Makluman ditambah untuk harga melebihi %@
price_alerts_added_price_under = Makluman ditambah untuk harga di bawah %@
price_alerts_added_increases_by = Makluman ditambah untuk kenaikan harga sebanyak %@
price_alerts_added_decreases_by = Makluman ditambah untuk penurunan harga sebanyak %@
...
info_estimated_confirmation_description = Anggaran ini berdasarkan yuran transaksi dan aktiviti rangkaian %@ semasa. Masa pengesahan sebenar mungkin berubah dan tidak dijamin.
...
info_balance_required_title = %@ diperlukan
info_insufficient_network_fee_balance_description = Transaksi ini memerlukan %@ untuk yuran rangkaian %@, tetapi hanya %@ tersedia. Anda memerlukan %@ lagi untuk meneruskan.
info_insufficient_balance_title = Baki Tidak Mencukupi
info_balance_required_description = Transaksi ini memerlukan %@, tetapi hanya %@ tersedia. Anda memerlukan %@ lagi untuk meneruskan.
...
nft_report_reason_inappropriate = Kandungan Tidak Sesuai
nft_report_reason_copyright = Hak Cipta
nft_report_reason_other = Lain-lain
...
onboarding_accept_terms_item1_message = Saya faham bahawa saya bertanggungjawab sepenuhnya untuk keselamatan dan sandaran dompet saya, bukan Gem.
