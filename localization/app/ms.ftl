...
info_receive_network_fee_title = %@ diperlukan untuk yuran
info_receive_network_fee_description = Anda menerima %@, tetapi anda tiada %@. Anda memerlukannya untuk membayar yuran rangkaian bagi transaksi akan datang pada %@.
