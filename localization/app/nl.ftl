...
common_copied_to_clipboard = Gekopieerd naar klembord
...
common_pinned_asset = Vastgezet: %@
common_unpinned_asset = Losgemaakt: %@
...
wallet_watch_tooltip_title = Alleen-kijken-portemonnee. Je hebt geen controle over deze tegoeden.
wallet_watch_empty_state_title = Je houdt deze portemonnee in de gaten.
wallet_stake = Inzet
...
support_state_empty_description = Vraag ons wat je maar wilt. We staan voor je klaar.
support_message_placeholder = Bericht
...
transaction_estimated_confirmation = Geschatte bevestiging
...
info_payment_verification_description = De verkoper vraagt om aanvullende informatie vóór de betaling.
...
info_estimated_confirmation_description = Deze schatting is gebaseerd op de transactiekosten en de huidige activiteit op het %@-netwerk. De werkelijke bevestigingstijd kan veranderen en wordt niet gegarandeerd.
...
info_balance_required_title = %@ vereist
info_insufficient_network_fee_balance_description = Deze transactie vereist %@ voor de netwerkkosten van %@, maar er is slechts %@ beschikbaar. Je hebt nog %@ nodig om door te gaan.
info_insufficient_balance_title = Onvoldoende saldo
info_balance_required_description = Deze transactie vereist %@, maar er is slechts %@ beschikbaar. Je hebt nog %@ nodig om door te gaan.
