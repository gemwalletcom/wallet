...
info_receive_network_fee_title = %@ vereist voor kosten
info_receive_network_fee_description = Je ontvangt %@, maar je hebt geen %@. Je hebt het nodig om netwerkkosten voor toekomstige transacties op %@ te betalen.
