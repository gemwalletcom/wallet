...
info_receive_network_fee_title = %@ wymagany do opłat
info_receive_network_fee_description = Otrzymujesz %@, ale nie masz %@. Będzie potrzebny do zapłaty opłat sieciowych za przyszłe transakcje w sieci %@.
