...
common_sign_in_with = Zaloguj się za pomocą %@
...
common_copied_to_clipboard = Skopiowano do schowka
...
common_pinned_asset = Przypięto: %@
common_unpinned_asset = Odpięto: %@
common_skip = Pomiń
...
wallet_watch_tooltip_title = Portfel tylko do obserwacji. Nie kontrolujesz tych środków.
wallet_watch_empty_state_title = Oglądasz ten portfel.
wallet_stake = Postaw
...
wallet_pay_with_card_or_bank = Zapłać kartą lub bankiem
# Used in the insufficient network fee sheet for the swap option subtitle.
wallet_from_your_wallet_assets = Z aktywów w portfelu
# Used in the insufficient network fee sheet for the receive option subtitle.
wallet_transfer_from_another_wallet = Przenieś z innego portfela
...
support_state_empty_description = Zapytaj nas o cokolwiek. Jesteśmy tu, aby pomóc.
support_message_placeholder = Wiadomość
...
errors_import_invalid_private_key = Nieprawidłowy klucz prywatny
errors_keystore_access = Nie udało się uzyskać dostępu do kluczy tego portfela na tym urządzeniu. Jeśli masz frazę odzyskiwania, usuń ten portfel i zaimportuj go ponownie, aby przywrócić dostęp.
errors_wallet_account_missing = Ten portfel nie ma konta w tej sieci
...
transaction_estimated_confirmation = Szacowane potwierdzenie
...
private_key_reveal_intro = Zaraz wyświetlisz klucz prywatny swojego konta %@.
private_key_do_not_share_title = Nie udostępniaj swojego klucza prywatnego!
private_key_do_not_share_description = Każdy, kto zdobędzie ten klucz prywatny, może przejąć pełną kontrolę nad Twoim kontem %@.
private_key_one_chain_title = Odblokowuje tylko jeden łańcuch
private_key_one_chain_description = Ten klucz kontroluje tylko konto %@.
private_key_shared_chains_title = Odblokowuje kilka łańcuchów
private_key_shared_chains_description = Ten klucz kontroluje Twoje konta w %@.
private_key_scope_evm = wszystkich sieciach EVM
private_key_scope_cosmos = wszystkich sieciach Cosmos
...
info_estimated_confirmation_description = To oszacowanie opiera się na opłacie transakcyjnej i bieżącej aktywności sieci %@. Rzeczywisty czas potwierdzenia może się zmienić i nie jest gwarantowany.
...
info_balance_required_title = %@ wymagane
info_insufficient_network_fee_balance_description = Ta transakcja wymaga %@ na opłatę sieciową %@, ale dostępne jest tylko %@. Aby kontynuować, potrzebujesz jeszcze %@.
...
info_stake_frozen_required_title = Zamroź TRX, aby postawić stawkę
info_stake_frozen_required_description = Staking na TRON składa się z dwóch kroków. Najpierw zamroź TRX, a następnie postaw je, aby zdobyć nagrody.
...
nft_properties = Właściwości
nft_collections = Kolekcje
...
nft_report_reason_inappropriate = Niewłaściwa treść
nft_report_reason_copyright = Prawo autorskie
nft_report_report_button_title = Zgłoś
