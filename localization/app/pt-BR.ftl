...
transfer_destination_account_activation = O endereço de destino requer um mínimo de %@.
...
stake_state_empty_validators_title = Nenhum validador encontrado
