...
common_copied_to_clipboard = Copiado para a área de transferência
...
common_pinned_asset = Fixado: %@
common_unpinned_asset = Desafixado: %@
common_skip = Pular
...
wallet_scan_hint = Envie, pague ou conecte-se a um DApp
wallet_scan_hint_address = Endereço da carteira
wallet_default_name = Carteira #%d
wallet_default_name_chain = %@ Carteira #%d
wallet_copy_address = Copiar endereço
wallet_watch_tooltip_title = Carteira somente de observação. Você não controla esses fundos.
wallet_watch_empty_state_title = Você está observando esta carteira.
...
transaction_estimated_confirmation = Confirmação estimada
...
private_key_reveal_intro = Você está prestes a revelar a chave privada da sua conta %@.
private_key_do_not_share_title = Não compartilhe sua chave privada!
private_key_do_not_share_description = Qualquer pessoa que obtiver esta chave privada pode assumir o controle total da sua conta %@.
private_key_one_chain_title = Desbloqueia apenas uma rede
private_key_one_chain_description = Esta chave controla apenas a conta %@.
private_key_shared_chains_title = Desbloqueia várias redes
private_key_shared_chains_description = Esta chave controla suas contas em %@.
private_key_scope_evm = todas as redes EVM
private_key_scope_cosmos = todas as redes Cosmos
...
info_estimated_confirmation_description = Esta estimativa se baseia na taxa da transação e na atividade atual da rede %@. O tempo real de confirmação pode mudar e não é garantido.
...
info_balance_required_title = %@ necessário
info_insufficient_network_fee_balance_description = Esta transação requer %@ para a taxa da rede %@, mas apenas %@ estão disponíveis. Você precisa de mais %@ para continuar.
info_insufficient_balance_title = Saldo insuficiente
info_balance_required_description = Esta transação requer %@, mas apenas %@ estão disponíveis. Você precisa de mais %@ para continuar.
...
info_stake_frozen_required_title = Congele TRX para fazer stake
info_stake_frozen_required_description = Fazer stake na TRON tem duas etapas. Primeiro congele TRX e depois faça stake para ganhar recompensas.
