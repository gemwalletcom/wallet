...
info_receive_network_fee_title = %@ necessário para as taxas
info_receive_network_fee_description = Você está recebendo %@, mas não tem %@. Você precisará dele para pagar as taxas de rede de transações futuras na %@.
