...
info_receive_network_fee_title = %@ necesar pentru taxe
info_receive_network_fee_description = Primești %@, dar nu ai %@. Vei avea nevoie de el pentru a plăti taxele de rețea pentru tranzacțiile viitoare pe %@.
