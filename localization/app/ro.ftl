...
common_copied_to_clipboard = Copiat în clipboard
...
common_pinned_asset = Fixat: %@
common_unpinned_asset = Fixare anulată: %@
...
wallet_watch_tooltip_title = Portofel doar pentru monitorizare. Nu controlezi aceste fonduri.
wallet_watch_empty_state_title = Te uiți la acest portofel.
...
transaction_estimated_confirmation = Confirmare estimată
...
info_estimated_confirmation_description = Această estimare se bazează pe taxa tranzacției și pe activitatea curentă a rețelei %@. Timpul real de confirmare se poate modifica și nu este garantat.
...
info_balance_required_title = %@ necesar
info_insufficient_network_fee_balance_description = Această tranzacție necesită %@ pentru taxa rețelei %@, dar sunt disponibili doar %@. Mai aveți nevoie de %@ pentru a continua.
info_insufficient_balance_title = Sold insuficient
info_balance_required_description = Această tranzacție necesită %@, dar sunt disponibili doar %@. Mai aveți nevoie de %@ pentru a continua.
...
nft_report_reason_other = Altele
