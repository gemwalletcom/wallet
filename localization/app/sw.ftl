...
common_copied_to_clipboard = Imenakiliwa kwenye ubao wa kunakili
...
common_lists = Orodha
common_unpin = Bandua
common_pinned_asset = Imebandikwa: %@
common_unpinned_asset = Imebanduliwa: %@
common_skip = Ruka
common_warning = Onyo
...
wallet_scan_hint = Tuma, lipa au unganisha na DApp
wallet_scan_hint_address = Anwani ya mkoba
wallet_default_name = Wallet #%d
wallet_default_name_chain = %@ Wallet #%d
wallet_copy_address = Nakili Anwani
wallet_watch_tooltip_title = Pochi ya kutazama tu. Huna udhibiti wa fedha hizi.
wallet_watch_empty_state_title = Unatazama pochi hii.
wallet_stake = Weka Hisa
...
transfer_stake_title = Weka Hisa
transfer_claim_rewards_title = Dai Zawadi
transfer_unstake_title = Ondoa Hisa
transfer_redelegate_title = Hamisha Uwakilishi
...
charts_price_change = Mabadiliko
...
price_alerts_set_alert_price_over = Wakati bei iko juu
...
info_payment_verification_description = Mfanyabiashara anaomba maelezo ya ziada kabla ya malipo.
...
info_estimated_confirmation_description = Makadirio haya yanategemea ada ya muamala na shughuli za sasa za mtandao wa %@. Muda halisi wa uthibitisho unaweza kubadilika na haujahakikishwa.
...
info_balance_required_title = %@ inahitajika
info_insufficient_network_fee_balance_description = Muamala huu unahitaji %@ kwa ada ya mtandao wa %@, lakini ni %@ pekee zinazopatikana. Unahitaji %@ zaidi ili kuendelea.
info_insufficient_balance_title = Salio halitoshi
info_balance_required_description = Muamala huu unahitaji %@, lakini ni %@ pekee zinazopatikana. Unahitaji %@ zaidi ili kuendelea.
...
nft_report_reason_other = Nyingine
...
perpetual_close_position = Funga Nafasi
perpetual_pnl = PnL
perpetual_long = Ndefu
perpetual_short = Fupi
...
perpetual_margin_usage = Matumizi ya Margin
perpetual_account_leverage = Uwiano wa Mtaji wa Akaunti
