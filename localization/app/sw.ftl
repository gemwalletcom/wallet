...
info_receive_network_fee_title = %@ inahitajika kwa ada
info_receive_network_fee_description = Unapokea %@, lakini huna %@. Utahitaji ili kulipia ada za mtandao kwa miamala ijayo kwenye %@.
