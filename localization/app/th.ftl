...
info_receive_network_fee_title = ต้องใช้ %@ สำหรับค่าธรรมเนียม
info_receive_network_fee_description = คุณกำลังรับ %@ แต่คุณไม่มี %@ คุณจะต้องใช้มันเพื่อชำระค่าธรรมเนียมเครือข่ายสำหรับธุรกรรมในอนาคตบน %@
