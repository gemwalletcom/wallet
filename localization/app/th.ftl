...
common_continue_anyway = ดำเนินการต่ออยู่ดี
...
common_copied_to_clipboard = คัดลอกไปยังคลิปบอร์ดแล้ว
...
common_pinned_asset = ปักหมุดแล้ว: %@
common_unpinned_asset = เลิกปักหมุดแล้ว: %@
common_skip = ข้าม
...
wallet_watch_tooltip_title = กระเป๋าเงินสำหรับดูเท่านั้น คุณไม่ได้ควบคุมเงินเหล่านี้
wallet_watch_empty_state_title = คุณกำลังดูกระเป๋าสตางค์นี้
wallet_stake = สเตค
...
wallet_sell = ขาย
wallet_receive_collection = รับการรวบรวม
wallet_more = มากกว่า
...
transaction_estimated_confirmation = เวลายืนยันโดยประมาณ
...
info_estimated_confirmation_description = การประมาณนี้อ้างอิงจากค่าธรรมเนียมธุรกรรมและกิจกรรมปัจจุบันของเครือข่าย %@ เวลายืนยันจริงอาจเปลี่ยนแปลงและไม่สามารถรับประกันได้
...
info_balance_required_title = %@ จำเป็น
info_insufficient_network_fee_balance_description = ธุรกรรมนี้ต้องใช้ %@ สำหรับค่าธรรมเนียมเครือข่าย %@ แต่มีเพียง %@ เท่านั้น คุณต้องการอีก %@ เพื่อดำเนินการต่อ
info_insufficient_balance_title = ยอดเงินคงเหลือไม่เพียงพอ
info_balance_required_description = ธุรกรรมนี้ต้องใช้ %@ แต่มีเพียง %@ เท่านั้น คุณต้องการอีก %@ เพื่อดำเนินการต่อ
...
info_swap_minimum_amount_description = %@ ต้องใช้อย่างน้อย %@ แต่จำนวนคือ %@ เพิ่มอีก %@ เพื่อดำเนินการต่อ
...
nft_properties = คุณสมบัติ
nft_collections = คอลเลคชั่น
nft_collection = ของสะสม
nft_save_to_photos = บันทึกลงในภาพถ่าย
nft_set_as_avatar = ตั้งเป็นอวาตาร์
nft_state_empty_title = NFT ของคุณจะปรากฏที่นี่
nft_state_empty_description = รับ NFT แรกของคุณ
nft_report_reason_spam = สแปม
...
rootcheck_jailbreak_body = อุปกรณ์ของคุณดูเหมือนจะถูกเจลเบรก ซึ่งอาจทำให้กระเป๋าเงินและเงินของคุณเสี่ยง
