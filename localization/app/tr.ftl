...
info_receive_network_fee_title = Ücretler için %@ gerekli
info_receive_network_fee_description = %@ alıyorsunuz, ancak %@ yok. %@ üzerindeki gelecekteki işlemlerin ağ ücretlerini ödemek için buna ihtiyacınız olacak.
