...
common_copied_to_clipboard = Panoya kopyalandı
...
common_unpin = Kaldır
common_pinned_asset = Sabitlendi: %@
common_unpinned_asset = Sabitleme kaldırıldı: %@
common_skip = Atla
...
wallet_watch_tooltip_title = Yalnızca izleme cüzdanı. Bu fonlar sizin kontrolünüzde değil.
wallet_watch_empty_state_title = Bu cüzdanı izliyorsunuz.
wallet_stake = Stake
...
errors_keystore_access = Bu cihazda bu cüzdanın anahtarlarına erişilemedi. Kurtarma ifadeniz varsa bu cüzdanı kaldırıp yeniden içe aktararak erişimi geri kazanabilirsiniz.
errors_wallet_account_missing = Bu cüzdanın bu ağ için hesabı yok
...
errors_authentication_unavailable = Bu cihazda kimlik doğrulama ayarlanmamış. Cihaz ayarlarından biyometriyi veya bir parolayı açın.
errors_authentication_locked_out = Çok fazla başarısız deneme. Lütfen daha sonra tekrar deneyin.
errors_authentication_failed = Kimlik doğrulama başarısız oldu. Lütfen tekrar deneyin.
errors_connections_expired = Bu bağlantı linkinin süresi doldu. Yeni bir QR kodu alıp tekrar deneyin.
errors_connections_not_found = Bu bağlantı artık mevcut değil.
errors_connections_relay_unavailable = WalletConnect'e ulaşılamadı. İnternet bağlantınızı kontrol edip tekrar deneyin.
...
transaction_estimated_confirmation = Tahmini onay
...
price_alerts_added_price_over = Fiyat %@ üzerine çıktığında uyarı eklendi
price_alerts_added_price_under = Fiyat %@ altına düştüğünde uyarı eklendi
price_alerts_added_increases_by = Fiyat %@ arttığında uyarı eklendi
price_alerts_added_decreases_by = Fiyat %@ düştüğünde uyarı eklendi
...
info_estimated_confirmation_description = Bu tahmin işlem ücreti ve mevcut %@ ağı etkinliğine dayanır. Gerçek onay süresi değişebilir ve garanti edilmez.
...
info_balance_required_title = %@ gerekli
info_insufficient_network_fee_balance_description = Bu işlem %@ ağ ücreti için %@ gerektirir, ancak yalnızca %@ kullanılabilir. Devam etmek için %@ daha gerekiyor.
info_insufficient_balance_title = Yetersiz Bakiye
info_balance_required_description = Bu işlem %@ gerektirir, ancak yalnızca %@ kullanılabilir. Devam etmek için %@ daha gerekiyor.
