...
errors_wallets_limit_description = آپ والیٹس کی اجازت کی زیادہ سے زیادہ تعداد تک پہنچ گئے ہیں ( %d )۔ ایک نیا شامل کرنے یا بنانے کے لیے براہ کرم موجودہ والیٹ کو ہٹا دیں۔
