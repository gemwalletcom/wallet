...
common_copied_to_clipboard = Đã sao chép vào bộ nhớ tạm
...
common_pinned_asset = Đã ghim: %@
common_unpinned_asset = Đã bỏ ghim: %@
common_skip = Bỏ qua
...
wallet_watch_tooltip_title = Ví chỉ để theo dõi. Bạn không kiểm soát số tiền này.
wallet_watch_empty_state_title = Bạn đang xem ví này.
...
transaction_estimated_confirmation = Xác nhận dự kiến
...
info_estimated_confirmation_description = Ước tính này dựa trên phí giao dịch và hoạt động hiện tại của mạng %@. Thời gian xác nhận thực tế có thể thay đổi và không được đảm bảo.
...
info_balance_required_title = %@ bắt buộc
info_insufficient_network_fee_balance_description = Giao dịch này yêu cầu %@ cho phí mạng %@, nhưng chỉ có %@ khả dụng. Bạn cần thêm %@ để tiếp tục.
info_insufficient_balance_title = Số dư không đủ
info_balance_required_description = Giao dịch này yêu cầu %@, nhưng chỉ có %@ khả dụng. Bạn cần thêm %@ để tiếp tục.
...
info_swap_minimum_amount_description = %@ yêu cầu tối thiểu %@, nhưng số tiền là %@. Hãy tăng thêm %@ để tiếp tục.
