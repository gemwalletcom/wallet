...
info_receive_network_fee_title = Cần %@ để trả phí
info_receive_network_fee_description = Bạn đang nhận %@, nhưng bạn không có %@. Bạn sẽ cần nó để trả phí mạng cho các giao dịch trong tương lai trên %@.
