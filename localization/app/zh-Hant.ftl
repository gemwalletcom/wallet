...
wallet_watch_empty_state_title = 您正在觀察此錢包。
wallet_stake = 質押
...
transaction_estimated_confirmation = 預計確認
...
swap_slippage = 滑點
swap_slippage_warning = 滑點過高。您的兌換可能以比預期更差的價格成交。
...
info_estimated_confirmation_description = 此估算根據交易手續費和 %@ 網路目前的活動。實際確認時間可能會變更，且無法保證。
...
info_insufficient_network_fee_balance_description = 此交易需要 %@ 支付 %@ 網路費用，但只有 %@ 可用。還需要 %@ 才能繼續。
